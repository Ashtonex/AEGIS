...
export function GlobalAmbition() {
  return (
    <section className="relative py-28 md:py-44 bg-void border-y border-ink-mid overflow-hidden">
      {/* Abstract Map Background */}
      <div className="absolute inset-0 z-0 opacity-20">
        <div className="absolute inset-0 bg-gradient-to-r from-void via-transparent to-void z-10" />
        <div className="absolute inset-0 bg-gradient-to-t from-void via-transparent to-void z-10" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-full max-h-[600px] z-0">
          <div className="w-full h-full" style={{
            backgroundImage: "radial-gradient(circle, var(--dxl-ink-mid) 1px, transparent 1px)",
          ...
          {/* Highlight Nodes */}
          <div className="absolute top-[40%] left-[50%] w-3 h-3 rounded-full bg-signal shadow-[0_0_20px_var(--dxl-signal)] animate-pulse" />
          <div className="absolute top-[60%] left-[45%] w-2 h-2 rounded-full bg-slate/50" />
          <div className="absolute top-[30%] left-[60%] w-2 h-2 rounded-full bg-slate/50" />
          <div className="absolute top-[70%] left-[55%] w-2 h-2 rounded-full bg-slate/50" />
        </div>
      </div>
      ...
      <div className="container relative z-20 text-center max-w-4xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20">
        <RevealOnScroll direction="up">
          ...
          <div className="text-left">
            ...
            <h2 className="text-display-xl text-paper mt-4 mb-8">Building Across<br />Southern Africa</h2>
            <p className="text-body-xl text-slate-light leading-relaxed max-w-2xl mb-12">
            ...
            <div className="flex flex-wrap items-center gap-4 text-[11px] font-sans font-semibold tracking-widest uppercase text-slate">
              <span className="text-signal">Zimbabwe</span>
