  ...
  const navItems = [
    ...
    { 
      ...
      subItems: [
        ...
        { name: "Opportunities", href: "/dashboard/crm/opportunities", icon: Briefcase, active: false },
        { name: "Tenders & Bids", href: "/dashboard/crm/tenders", icon: Building2, active: false },
        { name: "Organizations", href: "/dashboard/crm/organizations", icon: Handshake, active: false },
        { name: "Contacts", href: "/dashboard/crm/contacts", icon: Users, active: false },
        { name: "Subcontractors", href: "/dashboard/crm/subcontractors", icon: HardHat, active: true },
        { name: "Activities", href: "/dashboard/crm/activities", icon: MapPin, active: false },
        { name: "Documents", href: "/dashboard/crm/documents", icon: BookOpen, active: false },
        { name: "Sales Inbox", href: "/dashboard/crm/inbox", icon: Inbox, active: false },
        { name: "Automations", href: "/dashboard/crm/automations", icon: Zap, active: false },
      ]
    },
    { name: "Projects", href: "#", icon: HardHat, active: false },
    { name: "Site Operations", href: "#", icon: Activity, active: false },
    { name: "Workforce", href: "#", icon: Users, active: false },
    { name: "Fleet", href: "#", icon: Truck, active: false },
    { name: "Equipment", href: "#", icon: Wrench, active: false },
    { name: "Procurement", href: "#", icon: ShoppingCart, active: false },
    { name: "Inventory", href: "#", icon: Package, active: false },
    { name: "Finance", href: "#", icon: DollarSign, active: false },
    { name: "HR", href: "#", icon: UserCheck, active: false },
    { name: "Compliance", href: "#", icon: ShieldCheck, active: false },
    { name: "Documents", href: "#", icon: FileText, active: false },
    { name: "Reports", href: "#", icon: BarChart, active: false },
