      ...
      <section className="py-24 bg-void border-b border-ink-mid">
        <div className="container max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16 xl:px-20">
          <div className="text-center mb-16">
            ...
            <p className="text-body text-slate-light mt-4 max-w-2xl mx-auto">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <StaggerItem>
              <Card padding="standard" className="text-center border-t-2 border-t-signal">
                <Activity className="w-10 h-10 text-signal mx-auto mb-4" strokeWidth={1.5} />
                <h3 className="text-2xl font-bold font-display text-white">Tracked</h3>
                <p className="text-xs font-mono tracking-wider text-slate-light mt-2">LOST-TIME INJURIES MONITORED SITE-WIDE</p>
              </Card>
            </StaggerItem>
            <StaggerItem>
              <Card padding="standard" className="text-center border-t-2 border-t-signal">
                <ShieldCheck className="w-10 h-10 text-signal mx-auto mb-4" strokeWidth={1.5} />
                <h3 className="text-2xl font-bold font-display text-white">Logged</h3>
                <p className="text-xs font-mono tracking-wider text-slate-light mt-2">RECORDABLE INCIDENTS TRACKED PER PROGRAMME</p>
              </Card>
            </StaggerItem>
            <StaggerItem>
              <Card padding="standard" className="text-center border-t-2 border-t-signal">
                <Award className="w-10 h-10 text-signal mx-auto mb-4" strokeWidth={1.5} />
                <h3 className="text-2xl font-bold font-display text-white">Audited</h3>
                <p className="text-xs font-mono tracking-wider text-slate-light mt-2">PPE COMPLIANCE VERIFIED ON SITE</p>
              </Card>
            </StaggerItem>
            <StaggerItem>
              <Card padding="standard" className="text-center border-t-2 border-t-signal">
                <ShieldAlert className="w-10 h-10 text-signal mx-auto mb-4" strokeWidth={1.5} />
                <h3 className="text-2xl font-bold font-display text-white">Monitored</h3>
                <p className="text-xs font-mono tracking-wider text-slate-light mt-2">ENVIRONMENTAL COMPLIANCE ON EVERY SITE</p>
              </Card>
            </StaggerItem>
          </StaggerContainer>
        </div>
        ...
        <div className="container max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16 xl:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="p-6 border border-ink-mid bg-void">
