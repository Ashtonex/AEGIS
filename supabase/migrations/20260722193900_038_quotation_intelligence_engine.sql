...
VALUES (
    '038_quotation_intelligence_engine.sql',
    'e66096233d033ed7215abeb71c433eac4335546f9af842db6bffbc486182b6a4',
    45,
    NULL,
    'supabase-mcp'
)
ON CONFLICT (filename) DO UPDATE SET
    ...
    alembic_revision = COALESCE(EXCLUDED.alembic_revision, core.aegis_migration_log.alembic_revision),
    applied_by = CASE
