...
from routers import audit_controls
from routers import management_accounts
...
def create_app() -> FastAPI:
    ...
    app.include_router(drawings.router, prefix="/api/v1/drawings", tags=["Drawings"], dependencies=[Depends(require_resource_permission("drawings"))])  # fmt: skip
    ...
    app.include_router(crm_lifecycle.router, prefix="/api/v1/crm-lifecycle", tags=["CRM Lifecycle"])
    ...
    app.include_router(crm_integrations.router, prefix="/api/v1/crm-integrations", tags=["CRM Integrations"])  # fmt: skip
    app.include_router(crm_import_export.router, prefix="/api/v1/crm-import-export", tags=["CRM Import Export"])
    ...
    app.include_router(audit_controls.router, prefix="/api/v1/finance/audit", tags=["Finance Audit Controls"])
    app.include_router(management_accounts.router, prefix="/api/v1/finance/management-accounts", tags=["Finance Management Accounts"])
