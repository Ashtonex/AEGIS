...
COMPLIANCE_PAGE = (
    ...
    ROOT.parent / "aegis-web" / "src" / "app" / "dashboard" / "compliance" / "ComplianceTabPanels.tsx"
).read_text(encoding="utf-8")  # tab bodies now live here, see ComplianceTabPanels.tsx
