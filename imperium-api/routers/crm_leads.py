...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "crm_leads listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "crm_leads created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "crm_leads retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "crm_leads updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "crm_leads deleted (soft delete).", "meta": {}}
