...
"""
Module: projects
Description: Auto-generated CRUD endpoints for projects.projects.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "projects listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO projects.projects ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "projects created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "projects retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "projects updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "projects deleted (soft delete).", "meta": {}}
