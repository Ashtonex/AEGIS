...
"""
Module: payroll_runs
Description: Auto-generated CRUD endpoints for hr.payroll_runs.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "payroll_runs listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO hr.payroll_runs ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "payroll_runs created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "payroll_runs retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "payroll_runs updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "payroll_runs deleted (soft delete).", "meta": {}}
