...
Description: Auto-generated CRUD endpoints for finance.bank_transactions.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "bank_transactions listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO finance.bank_transactions ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "bank_transactions created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "bank_transactions retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "bank_transactions updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "bank_transactions deleted (soft delete).", "meta": {}}
