...
Description: Auto-generated CRUD endpoints for finance.bank_accounts.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "bank_accounts listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO finance.bank_accounts ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "bank_accounts created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "bank_accounts retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "bank_accounts updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "bank_accounts deleted (soft delete).", "meta": {}}
