...
"""
Module: bi_reports
Description: Auto-generated CRUD endpoints for executive.bi_reports.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "bi_reports listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO executive.bi_reports ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "bi_reports created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "bi_reports retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "bi_reports updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "bi_reports deleted (soft delete).", "meta": {}}
