...
"""
Module: automated_reports
Description: Auto-generated CRUD endpoints for executive.automated_reports.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "automated_reports listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO executive.automated_reports ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "automated_reports created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "automated_reports retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "automated_reports updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "automated_reports deleted (soft delete).", "meta": {}}
