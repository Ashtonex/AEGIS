...
Description: Auto-generated CRUD endpoints for procurement.procurement_orders.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "procurement_orders listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO procurement.procurement_orders ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "procurement_orders created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "procurement_orders retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "procurement_orders updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "procurement_orders deleted (soft delete).", "meta": {}}
