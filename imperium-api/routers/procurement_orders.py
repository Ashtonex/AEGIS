...
async def list_items(
    ...
    return {
        "success": True,
        "data": items,
        "message": "procurement_orders listed.",
...
async def create_item(
    ...
    query = insert_returning_id_sql("procurement.procurement_orders", safe_keys, safe_keys)
    ...
    try:
        ...
        return {
            "success": True,
            "data": {"id": new_id},
            "message": "procurement_orders created.",
            "meta": {},
        }
...
async def get_item(
    ...
    return {
        ...
        "message": "procurement_orders retrieved.",
        "meta": {},
    }
...
async def update_item(
    ...
    query = update_returning_id_sql("procurement.procurement_orders", safe_keys, safe_keys)
    ...
    try:
        ...
        return {
            "success": True,
            "data": {"id": item_id},
            "message": "procurement_orders updated.",
            "meta": {},
        }
...
async def delete_item(
    ...
    return {
        "success": True,
        "data": None,
        "message": "procurement_orders deleted (soft delete).",
        "meta": {},
    }
