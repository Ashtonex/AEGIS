...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "risk_register listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO executive.risk_register ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "risk_register created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "risk_register retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "risk_register updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "risk_register deleted (soft delete).", "meta": {}}
