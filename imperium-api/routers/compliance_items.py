...
"""
Module: compliance_items
Description: Auto-generated CRUD endpoints for core.compliance_items.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "compliance_items listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO core.compliance_items ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "compliance_items created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "compliance_items retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "compliance_items updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "compliance_items deleted (soft delete).", "meta": {}}
