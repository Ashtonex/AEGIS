...
Description: Auto-generated CRUD endpoints for crm.tickets.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "client_portal_tickets listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO crm.tickets ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "client_portal_tickets created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "client_portal_tickets retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "client_portal_tickets updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "client_portal_tickets deleted (soft delete).", "meta": {}}
