...
"""
Module: payments
Description: Auto-generated CRUD endpoints for finance.payments.
"""
...
async def list_items(
    ...
    return {"success": True, "data": items, "message": "payments listed.", "meta": {"total": len(items)}}
...
async def create_item(
    ...
    query = text(f"""
        INSERT INTO finance.payments ({columns})
        VALUES ({binds})
        RETURNING id
    """)
    ...
    try:
        ...
        return {"success": True, "data": {"id": new_id}, "message": "payments created.", "meta": {}}
...
async def get_item(
    ...
    return {"success": True, "data": dict(item._mapping), "message": "payments retrieved.", "meta": {}}
...
async def update_item(
    ...
    try:
        ...
        await db.commit()
        return {"success": True, "data": {"id": item_id}, "message": "payments updated.", "meta": {}}
...
async def delete_item(
    ...
    await db.commit()
    return {"success": True, "data": None, "message": "payments deleted (soft delete).", "meta": {}}
