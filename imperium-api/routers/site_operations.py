...
Description: Auto-generated CRUD endpoints for projects.site_operations.
"""
...
async def list_items(
    ...
    return {
        "success": True,
        "data": items,
        "message": "site_operations listed.",
...
async def create_item(
    ...
    user: dict = Depends(get_current_user),
    db: AsyncSession = Depends(get_db),
    _: dict = Depends(require_permission("site_operations.create")),
):
    ...
    query = insert_returning_id_sql("projects.site_operations", safe_keys, safe_keys)
    ...
    try:
        ...
        return {
            "success": True,
            "data": {"id": new_id},
            "message": "site_operations created.",
            "meta": {},
        }
...
async def get_item(
    ...
    return {
        ...
        "message": "site_operations retrieved.",
        "meta": {},
    }
...
async def update_item(
    ...
    user: dict = Depends(get_current_user),
    db: AsyncSession = Depends(get_db),
    _: dict = Depends(require_permission("site_operations.update")),
):
    payload = await request.json()
    safe_keys = safe_payload_columns(payload.keys())
    ...
    query = update_returning_id_sql("projects.site_operations", safe_keys, safe_keys)
    ...
    try:
        ...
        return {
            "success": True,
            "data": {"id": item_id},
            "message": "site_operations updated.",
            "meta": {},
        }
...
async def delete_item(
    ...
    user: dict = Depends(get_current_user),
    db: AsyncSession = Depends(get_db),
    _: dict = Depends(require_permission("site_operations.delete")),
):
    query = text("""
        UPDATE projects.site_operations
    ...
    return {
        "success": True,
        "data": None,
        "message": "site_operations deleted (soft delete).",
        "meta": {},
    }
